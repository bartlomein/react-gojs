...
var GojsDiagram = /** @class */ (function (_super) {
    ...
    GojsDiagram.prototype.init = function () {
        var _a = this.props, createDiagram = _a.createDiagram, diagramId = _a.diagramId, onModelChange = _a.onModelChange, defaultSelectedNode = _a.defaultSelectedNode;
        ...
        }), { linkFromPortIdProperty: this.props.linkFromPortIdProperty || '', linkToPortIdProperty: this.props.linkToPortIdProperty || '', nodeDataArray: this.props.model.nodeDataArray.slice(), linkDataArray: this.props.model.linkDataArray.slice(), nodeCategoryProperty: this.props.nodeCategoryProperty || 'category', linkKeyProperty: this.props.linkKeyProperty || '', makeUniqueLinkKeyFunction: this.props.makeUniqueLinkKeyFunction || null, copyNodeDataFunction: this.props.copyNodeDataFunction || null }));
    ...
    GojsDiagram.prototype.dispatchAll = function () {
        var _this = this;
        this.eventsToDispatch.forEach(function (eventToDispatch) { return _this.props.onModelChange(eventToDispatch); });
        this.eventsToDispatch = [];
    };
